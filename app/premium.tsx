...
const tierData: Record<MembershipTier, TierInfo> = {
  ...
  gold: {
    ...
    features: [
      ...
      { icon: Eye, text: '200 profile views/day', included: true },
      ...
      { icon: Zap, text: 'Monthly boosts & super likes', included: true },
    ],
  },
  vip: {
    name: 'VIP',
    ...
    features: [
      ...
      { icon: Star, text: 'Rewind + Priority matching', included: true },
      { icon: Zap, text: 'More monthly boosts & super likes', included: true },
    ],
  },
};
